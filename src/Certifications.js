        ...
        <div className="col-12 col-xl-11">
          ...
          <h1 className="certificationHeading display-3 fontPrimary colorSecondary ps-4 text-start">Certifications</h1>
            <div className="d-none d-xxl-flex col-xl-4 pt-2 ps-4">
             <img className="certificationImg" src="/images/Ruby on Rails Certification.jpg" />
            </div>
            <div className="col-12 col-xxl-8 altcademy my-auto mx-xxl-auto ps-4">
              <h2 className="certificationHeading colorPrimary fontSecondary mb-4">Ruby on Rails</h2>
              <h5 className="certificationDescription text-white fontSecondary mt-4">July 2022</h5>
              <br />
              <a className="d-block certificationLink btn shadow-lg fontSecondary mt-2" type="button" href="./media/Ruby on Rails Certification.pdf" target="_blank"><h5>Certification PDF</h5></a>
            </div>
          </div>

          <div className="d-xxl-flex row certificationRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="d-none d-xxl-flex col-xl-4 pt-2 ps-4">
             <img className="certificationImg" src="/images/Ruby Programming.jpg" />
            </div>
            <div className="col-12 col-xxl-8 mathGameProject my-auto mx-xxl-auto ps-4">
              <h2 className="certificationHeading colorPrimary fontSecondary mb-4">Ruby Programming</h2>
              
              <h5 className="certificationDescription text-white fontSecondary">June 2022</h5>
              <br />
              <a className="d-block certificationLink btn shadow-lg fontSecondary mt-2" type="button" href="./media/Ruby Programming Certification.pdf" target="_blank"><h5>Certification PDF</h5></a>
            </div>
          </div>
