    ...
    return (
      ...
      <div className="d-flex row mx-auto justify-content-center px-auto">
        ...
        <div className="col-12 col-xl-11">
          ...
          <h1 className="educationHeading display-3 fontPrimary colorSecondary ps-4 text-start">Education</h1>
            <div className="d-none d-xxl-flex col-xl-4 pt-2 ps-xl-4 altcademy">
             <img className="educationImg" src="/images/Altcademy.jpg" />
            </div>
            <div className="col-12 col-xl-8 altcademy my-auto mx-xxl-auto ps-4">
          ...
          <div className="d-xxl-flex row educationRow border-start my-4 rounded mt-xl-2 mx-auto">
            ...
            <div className="col-12 col-xl-8 mathGameProject my-auto mx-xxl-auto ps-4">
          ...
          <div className="d-xxl-flex row educationRow border-start my-4 rounded mt-xl-2 mx-auto">
            ...
            <div className="col-12 col-xl-8 toDoListProject my-auto mx-xxl-auto ps-4">
