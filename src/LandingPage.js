  ...
  render() {
    return (
      ...
      <div className="d-flex row justify-content-center align-items-center mt-xl-2 pt-xl-2 my-xl-auto py-xl-auto">
        ...
        <div className="border-start col-11 col-xl-6 ps-4">
          <h3 className="fontSecondary text-white text-start mb-0 pb-0">Latest Updates:</h3>
            <h5 className="fontPrimary color-light text-start mt-2 ms-2">June 2022 -</h5>
              ...
              <h5 className="fontPrimary color-light text-start ms-4"><a className="updatesLink me-1" href="https://www.linkedin.com/in/collin-dapper-a1b59a152/details/skills/" target="_blank"><i className="fab fa-linkedin me-1"></i></a>Endorsed for HTML, CSS, JavaScript, and Full-Stack Development</h5>
