    ...
    return (
      ...
      <div className="d-flex row mx-auto justify-content-center px-auto">
        ...
        <div className="col-12 col-xl-11">
          <h1 className="projectsHeading display-3 fontPrimary colorSecondary px-xl-2 mb-5 mb-xxl-0 text-center text-xxl-start">Projects</h1>


          <div className="d-xxl-flex row projectRow border-start my-xl-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 currencyConverterProjectImg">
             <img className="projectsImg" src="/images/Currency Converter.jpg" />
            </div>
            <div className="col-12 col-xxl-8 currencyConverterProject my-auto mx-xl-auto ps-xl-4 mt-2 mt-xl-0">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 mathGameProjectImg">
             <img className="projectsImg" src="/images/10 sec math game.jpg" />
            </div>
            <div className="col-12 col-xxl-8 mathGameProject my-auto mx-xl-auto ps-xl-4 mt-2 mt-xl-0">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 toDoListProjectImg">
            <img className="projectsImg" src="/images/API To Do List.jpg" />
            </div>
            <div className="col-12 col-xxl-8 toDoListProject my-auto mx-xl-auto ps-xl-4 mt-2 mt-xl-0">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 shoppingListProjectImg">
            <img className="projectsImg" src="/images/Shopping List.jpg" />
            </div>
            <div className="col-12 col-xxl-8 shoppingListProject my-auto mx-xl-auto ps-xl-4 mt-2 mt-xl-0">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 blackjackProjectImg">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 rockPaperScissorsProjectImg">
            <img className="projectsImg" src="/images/Rock Paper Scissors Game.jpg" />
            </div>
            <div className="col-12 col-xl-8 shoppingListProject my-auto mx-xl-auto ps-xl-4 mt-2 mt-xl-0">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 personalPortfolioProjectImg">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 airbnbNewsProjectImg">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 airbnbBookingProjectImg">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 newsweekProjectImg">
          ...
          <div className="d-xxl-flex row projectRow border-start my-4 rounded mt-xl-2 mx-auto">
            <div className="col-12 col-xxl-4 pt-2 ps-xl-4 appleProjectImg">
